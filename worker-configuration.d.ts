/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 9578aa7564f2199fd0c65da2d02121a8)
// Runtime types generated with workerd@1.20260120.0 2026-01-04 global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
	...
	interface Env {
		...
		ASSETS: Fetcher;
		APP_URL: string;
		NOW_PAYMENT_API_URL: string;
		NOW_PAYMENT_API_KEY: string;
		NOW_PAYMENT_IPN_KEY: string;
		SUPPORT_URL: string;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_URL" | "NOW_PAYMENT_API_URL" | "NOW_PAYMENT_API_KEY" | "NOW_PAYMENT_IPN_KEY" | "SUPPORT_URL">> {}
}
